...
\textcolor{blue}{第一章不要少于4页\cite{hww}}	。
...
念奴娇$\bullet$赤壁怀古 \textcolor{blue}{图\ref{task2}}
...
\begin{figure}[htb]
	...
	\begin{center}
		\includegraphics[scale=0.25]{Sushi.jpg}
		\caption{Sushi.}
		\label{task2}
	\end{center}
\end{figure}
...
第三章不要少于6页\cite{STR2021Neurocom}。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。\textcolor{blue}{我是字。\ref{task3-1}我是字。\ref{task3-2}}

\begin{align}\label{task3-1}
	f(x)&=4(x+3)^2-4\nonumber\\
	&=4x^2+24x+36
\end{align}

\begin{eqnarray}\label{task3-2}
	S=\int_{a}^{b}f(x)dx=\sum_{i=1}^{n}\frac{f(x_{i})+f(x_{i+1})}{2}h\approx\{\frac{1}{2}(f(a)+f(b))+\sum_{i=1}^{n-1}f(x_{i})\}h
\end{eqnarray}
...
\textcolor{blue}{table-task4 \ref{table_eval}}
我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。我是字。
