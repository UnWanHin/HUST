...
\lstdefinestyle{commonCodeStyle}{
	...
	commentstyle=\color{green}\itshape, % 注释样式，斜体绿色显示
...
\begin{document}
	...
	\section{前言}
	\listoflistings
	\begin{lstlisting}[style=commonCodeStyle, caption={用户登录验证代码}, label={lst:loginVerify}]
		#include <stdio.h>
		#include <string.h>
	...
	\end{lstlisting}
	\begin{lstlisting}[style=commonCodeStyle, caption={用户登录验证代码}, label={lst:loginVerify2}]
	#include <stdio.h>
	#include <string.h>
